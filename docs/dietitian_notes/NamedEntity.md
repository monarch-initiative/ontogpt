...
URI: [dietitian_notes:NamedEntity](dietitian_notes:NamedEntity)
...
## Inheritance
* **NamedEntity**
    * [ClinicalObservations](ClinicalObservations.md)
    * [TherapeuticMaterial](TherapeuticMaterial.md)
    * [NutritionSupportMethod](NutritionSupportMethod.md)
    * [Disease](Disease.md)
    * [Drug](Drug.md)
    * [Unit](Unit.md)
...
| ---  | ---  |
| self | dietitian_notes:NamedEntity |
| native | dietitian_notes:NamedEntity |
