 ...
 * [➞disease](drugMechanism__disease.md) - the name of the disease that is treated
 * [➞drug](drugMechanism__drug.md) - the name of the drug that treats the disease
 * [➞mechanism_links](drugMechanism__mechanism_links.md) - semicolon-separated list of links, where each link is a triple connecting two entities via a relationship type
 * [➞references](drugMechanism__references.md)
 * [➞source_text](drugMechanism__source_text.md)
 ...
 * [➞object](mechanismLink__object.md)
 * [➞predicate](mechanismLink__predicate.md)
 * [➞subject](mechanismLink__subject.md)
