...
URI: [cell_type:NamedEntity](http://w3id.org/ontogpt/cell_type/NamedEntity)
...
* **NamedEntity**
    * [Gene](Gene.md)
    * [ProteinOrComplex](ProteinOrComplex.md)
    * [BiologicalProcess](BiologicalProcess.md)
    * [Pathway](Pathway.md)
    * [AnatomicalStructure](AnatomicalStructure.md)
    * [ChemicalEntity](ChemicalEntity.md)
    * [CellOntologyTerm](CellOntologyTerm.md)
    * [Disease](Disease.md)
    * [Drug](Drug.md)
...
| ---  | ---  |
| self | cell_type:NamedEntity |
| native | cell_type:NamedEntity |
