...
URI: [geneextraction:NamedEntity](http://w3id.org/ontogpt/gene_extractionNamedEntity)
...
| ---  | ---  |
| self | geneextraction:NamedEntity |
| native | geneextraction:NamedEntity |
