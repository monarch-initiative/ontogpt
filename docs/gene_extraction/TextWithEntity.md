...
URI: [geneextraction:TextWithEntity](http://w3id.org/ontogpt/gene_extractionTextWithEntity)
...
| ---  | ---  |
| self | geneextraction:TextWithEntity |
| native | geneextraction:TextWithEntity |
