...
URI: [geneextraction:AnnotatorResult](http://w3id.org/ontogpt/gene_extractionAnnotatorResult)
...
| ---  | ---  |
| self | geneextraction:AnnotatorResult |
| native | geneextraction:AnnotatorResult |
