...
URI: [geneextraction:RelationshipType](http://w3id.org/ontogpt/gene_extractionRelationshipType)
...
| ---  | ---  |
| self | geneextraction:RelationshipType |
| native | geneextraction:RelationshipType |
