...
URI: [geneextraction:ExtractionResult](http://w3id.org/ontogpt/gene_extractionExtractionResult)
...
| ---  | ---  |
| self | geneextraction:ExtractionResult |
| native | geneextraction:ExtractionResult |
