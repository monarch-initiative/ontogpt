...
URI: [geneextraction:TextWithTriples](http://w3id.org/ontogpt/gene_extractionTextWithTriples)
...
| ---  | ---  |
| self | geneextraction:TextWithTriples |
| native | geneextraction:TextWithTriples |
