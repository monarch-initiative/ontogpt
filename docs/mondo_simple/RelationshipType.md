...
URI: [mondo_simple:RelationshipType](http://w3id.org/ontogpt/emapa_simpleRelationshipType)
...
| ---  | ---  |
| self | mondo_simple:RelationshipType |
| native | mondo_simple:RelationshipType |
