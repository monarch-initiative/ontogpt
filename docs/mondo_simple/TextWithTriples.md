...
URI: [mondo_simple:TextWithTriples](http://w3id.org/ontogpt/emapa_simpleTextWithTriples)
...
| ---  | ---  |
| self | mondo_simple:TextWithTriples |
| native | mondo_simple:TextWithTriples |
