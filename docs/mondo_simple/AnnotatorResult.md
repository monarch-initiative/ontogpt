...
URI: [mondo_simple:AnnotatorResult](http://w3id.org/ontogpt/emapa_simpleAnnotatorResult)
...
| ---  | ---  |
| self | mondo_simple:AnnotatorResult |
| native | mondo_simple:AnnotatorResult |
