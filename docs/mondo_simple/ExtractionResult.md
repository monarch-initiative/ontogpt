...
URI: [mondo_simple:ExtractionResult](http://w3id.org/ontogpt/emapa_simpleExtractionResult)
...
| ---  | ---  |
| self | mondo_simple:ExtractionResult |
| native | mondo_simple:ExtractionResult |
