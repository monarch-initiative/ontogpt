...
URI: [emapa_simple:ExtractionResult](http://w3id.org/ontogpt/emapa_simpleExtractionResult)
...
| ---  | ---  |
| self | emapa_simple:ExtractionResult |
| native | emapa_simple:ExtractionResult |
