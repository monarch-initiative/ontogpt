...
URI: [emapa_simple:RelationshipType](http://w3id.org/ontogpt/emapa_simpleRelationshipType)
...
| ---  | ---  |
| self | emapa_simple:RelationshipType |
| native | emapa_simple:RelationshipType |
