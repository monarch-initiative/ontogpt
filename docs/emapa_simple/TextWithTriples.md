...
URI: [emapa_simple:TextWithTriples](http://w3id.org/ontogpt/emapa_simpleTextWithTriples)
...
| ---  | ---  |
| self | emapa_simple:TextWithTriples |
| native | emapa_simple:TextWithTriples |
