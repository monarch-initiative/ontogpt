...
URI: [go_terms_relational:ExtractionResult](http://w3id.org/ontogpt/go_terms_relationalExtractionResult)
...
| ---  | ---  |
| self | go_terms_relational:ExtractionResult |
| native | go_terms_relational:ExtractionResult |
