...
URI: [go_terms_relational:NamedEntity](http://w3id.org/ontogpt/go_terms_relationalNamedEntity)
...
| ---  | --- | --- | --- |
| [ProteinToGORelationship](ProteinToGORelationship.md) | [subject_qualifier](subject_qualifier.md) | range | [NamedEntity](NamedEntity.md) |
| [ProteinToGORelationship](ProteinToGORelationship.md) | [object_qualifier](object_qualifier.md) | range | [NamedEntity](NamedEntity.md) |
...
| ---  | ---  |
| self | go_terms_relational:NamedEntity |
| native | go_terms_relational:NamedEntity |
