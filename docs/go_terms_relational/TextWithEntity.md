...
URI: [go_terms_relational:TextWithEntity](http://w3id.org/ontogpt/go_terms_relationalTextWithEntity)
...
| ---  | ---  |
| self | go_terms_relational:TextWithEntity |
| native | go_terms_relational:TextWithEntity |
