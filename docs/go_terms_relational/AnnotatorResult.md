...
URI: [go_terms_relational:AnnotatorResult](http://w3id.org/ontogpt/go_terms_relationalAnnotatorResult)
...
| ---  | ---  |
| self | go_terms_relational:AnnotatorResult |
| native | go_terms_relational:AnnotatorResult |
