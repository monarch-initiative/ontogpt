...
URI: [go_terms_relational:Triple](http://w3id.org/ontogpt/go_terms_relationalTriple)
...
* [CompoundExpression](CompoundExpression.md)
    * **Triple**
        * [ProteinToGORelationship](ProteinToGORelationship.md)
...
| ---  | ---  |
| self | go_terms_relational:Triple |
| native | go_terms_relational:Triple |
