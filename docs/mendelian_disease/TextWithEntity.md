...
URI: [mendelian_disease:TextWithEntity](http://w3id.org/ontogpt/mendelian_disease/TextWithEntity)
...
| ---  | ---  |
| self | mendelian_disease:TextWithEntity |
| native | mendelian_disease:TextWithEntity |
