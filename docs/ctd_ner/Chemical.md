...
URI: [ctdner:Chemical](http://w3id.org/ontogpt/ctd_nerChemical)
...
| ---  | --- | --- | --- |
| [ChemicalToDiseaseDocument](ChemicalToDiseaseDocument.md) | [chemicals](chemicals.md) | range | [Chemical](Chemical.md) |
...
| ---  | ---  |
| self | ctdner:Chemical |
| native | ctdner:Chemical |
