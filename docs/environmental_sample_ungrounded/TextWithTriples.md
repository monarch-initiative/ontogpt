...
URI: [sample:TextWithTriples](http://w3id.org/ontogpt/environmental-sample-ungrounded/TextWithTriples)
...
| ---  | ---  |
| self | sample:TextWithTriples |
| native | sample:TextWithTriples |
