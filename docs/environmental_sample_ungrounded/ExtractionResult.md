...
URI: [sample:ExtractionResult](http://w3id.org/ontogpt/environmental-sample-ungrounded/ExtractionResult)
...
| ---  | ---  |
| self | sample:ExtractionResult |
| native | sample:ExtractionResult |
