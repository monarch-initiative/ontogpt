...
URI: [sample:RelationshipType](http://w3id.org/ontogpt/environmental-sample-ungrounded/RelationshipType)
...
| ---  | ---  |
| self | sample:RelationshipType |
| native | sample:RelationshipType |
