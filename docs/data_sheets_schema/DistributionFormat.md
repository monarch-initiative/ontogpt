...
_How will the dataset will be distributed (e.g., tarball on website, API, GitHub)?_
...
description: How will the dataset will be distributed (e.g., tarball on website, API,
  GitHub)?
in_subset:
- Distribution
