...
_Do any export controls or other regulatory restrictions apply to the dataset or to individual instances? If so, please describe these restrictions, and provide a link or other access point to, or otherwise reproduce, any supporting documentation._
...
description: Do any export controls or other regulatory restrictions apply to the
  ...
  provide a link or other access point to, or otherwise reproduce, any supporting
  documentation.
in_subset:
- Distribution
