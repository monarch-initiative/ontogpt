...
URI: [desiccation:RelationshipType](http://w3id.org/ontogpt/desiccationRelationshipType)
...
| ---  | ---  |
| self | desiccation:RelationshipType |
| native | desiccation:RelationshipType |
