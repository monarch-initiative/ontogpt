...
URI: [desiccation:ExtractionResult](http://w3id.org/ontogpt/desiccationExtractionResult)
...
| ---  | ---  |
| self | desiccation:ExtractionResult |
| native | desiccation:ExtractionResult |
