...
URI: [desiccation:NamedEntity](http://w3id.org/ontogpt/desiccationNamedEntity)
...
## Inheritance
* **NamedEntity**
    * [EntityContainingDocument](EntityContainingDocument.md)
    * [EnvironmentalCondition](EnvironmentalCondition.md)
    * [Taxon](Taxon.md)
    * [Trait](Trait.md)
...
| ---  | ---  |
| self | desiccation:NamedEntity |
| native | desiccation:NamedEntity |
