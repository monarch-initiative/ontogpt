...
URI: [genesummary:ExtractionResult](http://w3id.org/ontogpt/genesummary/ExtractionResult)
...
| ---  | ---  |
| self | genesummary:ExtractionResult |
| native | genesummary:ExtractionResult |
