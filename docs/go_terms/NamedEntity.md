...
URI: [go_terms:NamedEntity](http://w3id.org/ontogpt/go_termsNamedEntity)
...
* **NamedEntity**
    ...
    * [MolecularFunction](MolecularFunction.md)
...
| ---  | --- | --- | --- |
| [Document](Document.md) | [entities](entities.md) | range | [NamedEntity](NamedEntity.md) |
...
| ---  | ---  |
| self | go_terms:NamedEntity |
| native | go_terms:NamedEntity |
