...
URI: [composite_disease:ExtractionResult](http://w3id.org/ontogpt/composite_disease/ExtractionResult)
...
| ---  | ---  |
| self | composite_disease:ExtractionResult |
| native | composite_disease:ExtractionResult |
