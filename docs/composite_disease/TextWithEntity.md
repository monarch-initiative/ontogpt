...
URI: [composite_disease:TextWithEntity](http://w3id.org/ontogpt/composite_disease/TextWithEntity)
...
| ---  | ---  |
| self | composite_disease:TextWithEntity |
| native | composite_disease:TextWithEntity |
