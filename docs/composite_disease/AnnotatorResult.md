...
URI: [composite_disease:AnnotatorResult](http://w3id.org/ontogpt/composite_disease/AnnotatorResult)
...
| ---  | ---  |
| self | composite_disease:AnnotatorResult |
| native | composite_disease:AnnotatorResult |
