...
URI: [composite_disease:TextWithTriples](http://w3id.org/ontogpt/composite_disease/TextWithTriples)
...
| ---  | ---  |
| self | composite_disease:TextWithTriples |
| native | composite_disease:TextWithTriples |
