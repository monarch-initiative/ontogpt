...
URI: [all_disease_grounding:TextWithEntity](all_disease_grounding:TextWithEntity)
...
| ---  | ---  |
| self | all_disease_grounding:TextWithEntity |
| native | all_disease_grounding:TextWithEntity |
