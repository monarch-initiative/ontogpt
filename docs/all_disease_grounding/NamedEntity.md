...
URI: [all_disease_grounding:NamedEntity](all_disease_grounding:NamedEntity)
...
## Inheritance
* **NamedEntity**
    * [DiseaseTermSet](DiseaseTermSet.md)
    * [DiseaseTerm](DiseaseTerm.md)
...
| ---  | ---  |
| self | all_disease_grounding:NamedEntity |
| native | all_disease_grounding:NamedEntity |
