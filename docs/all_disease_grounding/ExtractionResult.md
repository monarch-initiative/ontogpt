...
URI: [all_disease_grounding:ExtractionResult](all_disease_grounding:ExtractionResult)
...
| ---  | ---  |
| self | all_disease_grounding:ExtractionResult |
| native | all_disease_grounding:ExtractionResult |
