...
URI: [all_disease_grounding:RelationshipType](all_disease_grounding:RelationshipType)
...
| ---  | ---  |
| self | all_disease_grounding:RelationshipType |
| native | all_disease_grounding:RelationshipType |
