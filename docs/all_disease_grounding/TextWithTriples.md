...
URI: [all_disease_grounding:TextWithTriples](all_disease_grounding:TextWithTriples)
...
| ---  | ---  |
| self | all_disease_grounding:TextWithTriples |
| native | all_disease_grounding:TextWithTriples |
