...
URI: [all_disease_grounding:AnnotatorResult](all_disease_grounding:AnnotatorResult)
...
| ---  | ---  |
| self | all_disease_grounding:AnnotatorResult |
| native | all_disease_grounding:AnnotatorResult |
