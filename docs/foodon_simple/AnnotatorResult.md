...
URI: [foodon_simple:AnnotatorResult](http://w3id.org/ontogpt/foodon_simpleAnnotatorResult)
...
| ---  | ---  |
| self | foodon_simple:AnnotatorResult |
| native | foodon_simple:AnnotatorResult |
