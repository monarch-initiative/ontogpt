...
URI: [foodon_simple:RelationshipType](http://w3id.org/ontogpt/foodon_simpleRelationshipType)
...
| ---  | ---  |
| self | foodon_simple:RelationshipType |
| native | foodon_simple:RelationshipType |
