...
URI: [foodon_simple:TextWithEntity](http://w3id.org/ontogpt/foodon_simpleTextWithEntity)
...
| ---  | ---  |
| self | foodon_simple:TextWithEntity |
| native | foodon_simple:TextWithEntity |
