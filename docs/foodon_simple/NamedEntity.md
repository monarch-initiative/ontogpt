...
URI: [foodon_simple:NamedEntity](http://w3id.org/ontogpt/foodon_simpleNamedEntity)
...
## Inheritance
* **NamedEntity**
    * [OntologyTermSet](OntologyTermSet.md)
...
| ---  | ---  |
| self | foodon_simple:NamedEntity |
| native | foodon_simple:NamedEntity |
