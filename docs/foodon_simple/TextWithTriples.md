...
URI: [foodon_simple:TextWithTriples](http://w3id.org/ontogpt/foodon_simpleTextWithTriples)
...
| ---  | ---  |
| self | foodon_simple:TextWithTriples |
| native | foodon_simple:TextWithTriples |
