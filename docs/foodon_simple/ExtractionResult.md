...
URI: [foodon_simple:ExtractionResult](http://w3id.org/ontogpt/foodon_simpleExtractionResult)
...
| ---  | ---  |
| self | foodon_simple:ExtractionResult |
| native | foodon_simple:ExtractionResult |
