...
URI: [coffee:NamedEntity](http://w3id.org/ontogpt/coffee/NamedEntity)
...
| ---  | --- | --- | --- |
| [id](id.md) | 1..1 <br/> [String](String.md) | A unique identifier for the named entity | direct |
...
| ---  | ---  |
| self | coffee:NamedEntity |
| native | coffee:NamedEntity |
