...
URI: [error_analysis:RelationshipType](http://w3id.org/ontogpt/error_analysisRelationshipType)
...
| ---  | ---  |
| self | error_analysis:RelationshipType |
| native | error_analysis:RelationshipType |
