...
URI: [error_analysis:TextWithTriples](http://w3id.org/ontogpt/error_analysisTextWithTriples)
...
| ---  | ---  |
| self | error_analysis:TextWithTriples |
| native | error_analysis:TextWithTriples |
