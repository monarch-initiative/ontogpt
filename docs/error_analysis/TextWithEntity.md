...
URI: [error_analysis:TextWithEntity](http://w3id.org/ontogpt/error_analysisTextWithEntity)
...
| ---  | ---  |
| self | error_analysis:TextWithEntity |
| native | error_analysis:TextWithEntity |
