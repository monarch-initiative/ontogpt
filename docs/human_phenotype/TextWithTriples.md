...
URI: [human_phenotype:TextWithTriples](http://w3id.org/ontogpt/human_phenotypeTextWithTriples)
...
| ---  | ---  |
| self | human_phenotype:TextWithTriples |
| native | human_phenotype:TextWithTriples |
