...
URI: [human_phenotype:NamedEntity](http://w3id.org/ontogpt/human_phenotypeNamedEntity)
...
## Inheritance
* **NamedEntity**
    * [HumanPhenotypeSet](HumanPhenotypeSet.md)
    * [HumanPhenotype](HumanPhenotype.md)
...
| ---  | ---  |
| self | human_phenotype:NamedEntity |
| native | human_phenotype:NamedEntity |
