...
URI: [human_phenotype:TextWithEntity](http://w3id.org/ontogpt/human_phenotypeTextWithEntity)
...
| ---  | ---  |
| self | human_phenotype:TextWithEntity |
| native | human_phenotype:TextWithEntity |
