...
URI: [human_phenotype:RelationshipType](http://w3id.org/ontogpt/human_phenotypeRelationshipType)
...
| ---  | ---  |
| self | human_phenotype:RelationshipType |
| native | human_phenotype:RelationshipType |
