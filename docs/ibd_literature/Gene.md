...
| [GeneExposureRelationship](GeneExposureRelationship.md) | [object](object.md) | range | [Gene](Gene.md) |
...
| property | value |
| --- | --- |
| annotators | sqlite:obo:hgnc, sqlite:obo:pr || prompt | the name of the gene in the pair. This comes second in the pair. |
