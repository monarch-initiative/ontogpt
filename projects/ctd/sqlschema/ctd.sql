...
CREATE TABLE "ChemicalToDiseaseDocument" (
	publication TEXT, 
	triples TEXT, 
	PRIMARY KEY (publication, triples)
);

CREATE TABLE "ChemicalToDiseasePredicate" (
	id TEXT NOT NULL, 
	label TEXT, 
	PRIMARY KEY (id)
);
...
CREATE TABLE "ChemicalToDiseaseRelationship" (
	qualifier TEXT, 
	subject TEXT, 
	object TEXT, 
	predicate TEXT, 
	...
	FOREIGN KEY(subject) REFERENCES "Chemical" (id), 
	FOREIGN KEY(object) REFERENCES "Disease" (id), 
	FOREIGN KEY(predicate) REFERENCES "ChemicalToDiseasePredicate" (id)
);
