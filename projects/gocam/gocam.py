...
# Generation date: 2023-08-07T10:53:47
...
@dataclass
class GoCamAnnotations(YAMLRoot):
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = GOCAM.GoCamAnnotations
    class_class_curie: ClassVar[str] = "gocam:GoCamAnnotations"
    class_name: ClassVar[str] = "GoCamAnnotations"
    class_model_uri: ClassVar[URIRef] = GOCAM.GoCamAnnotations
...
slots.goCamAnnotations__genes = Slot(uri=GOCAM.genes, name="goCamAnnotations__genes", curie=GOCAM.curie('genes'),
                   model_uri=GOCAM.goCamAnnotations__genes, domain=None, range=Optional[Union[Union[str, GeneId], List[Union[str, GeneId]]]])

slots.goCamAnnotations__organisms = Slot(uri=GOCAM.organisms, name="goCamAnnotations__organisms", curie=GOCAM.curie('organisms'),
                   model_uri=GOCAM.goCamAnnotations__organisms, domain=None, range=Optional[Union[Union[str, OrganismId], List[Union[str, OrganismId]]]])

slots.goCamAnnotations__gene_organisms = Slot(uri=GOCAM.gene_organisms, name="goCamAnnotations__gene_organisms", curie=GOCAM.curie('gene_organisms'),
                   model_uri=GOCAM.goCamAnnotations__gene_organisms, domain=None, range=Optional[Union[Union[dict, GeneOrganismRelationship], List[Union[dict, GeneOrganismRelationship]]]])

slots.goCamAnnotations__activities = Slot(uri=GOCAM.activities, name="goCamAnnotations__activities", curie=GOCAM.curie('activities'),
                   model_uri=GOCAM.goCamAnnotations__activities, domain=None, range=Optional[Union[Union[str, MolecularActivityId], List[Union[str, MolecularActivityId]]]])

slots.goCamAnnotations__gene_functions = Slot(uri=GOCAM.gene_functions, name="goCamAnnotations__gene_functions", curie=GOCAM.curie('gene_functions'),
                   model_uri=GOCAM.goCamAnnotations__gene_functions, domain=None, range=Optional[Union[Union[dict, GeneMolecularActivityRelationship], List[Union[dict, GeneMolecularActivityRelationship]]]])

slots.goCamAnnotations__cellular_processes = Slot(uri=GOCAM.cellular_processes, name="goCamAnnotations__cellular_processes", curie=GOCAM.curie('cellular_processes'),
                   model_uri=GOCAM.goCamAnnotations__cellular_processes, domain=None, range=Optional[Union[Union[str, CellularProcessId], List[Union[str, CellularProcessId]]]])

slots.goCamAnnotations__pathways = Slot(uri=GOCAM.pathways, name="goCamAnnotations__pathways", curie=GOCAM.curie('pathways'),
                   model_uri=GOCAM.goCamAnnotations__pathways, domain=None, range=Optional[Union[Union[str, PathwayId], List[Union[str, PathwayId]]]])

slots.goCamAnnotations__gene_gene_interactions = Slot(uri=GOCAM.gene_gene_interactions, name="goCamAnnotations__gene_gene_interactions", curie=GOCAM.curie('gene_gene_interactions'),
                   model_uri=GOCAM.goCamAnnotations__gene_gene_interactions, domain=None, range=Optional[Union[Union[dict, GeneGeneInteraction], List[Union[dict, GeneGeneInteraction]]]])

slots.goCamAnnotations__gene_localizations = Slot(uri=GOCAM.gene_localizations, name="goCamAnnotations__gene_localizations", curie=GOCAM.curie('gene_localizations'),
                   model_uri=GOCAM.goCamAnnotations__gene_localizations, domain=None, range=Optional[Union[Union[dict, GeneSubcellularLocalizationRelationship], List[Union[dict, GeneSubcellularLocalizationRelationship]]]])
