...
CREATE TABLE "MetabolicProcessCategory" (
	id TEXT NOT NULL, 
	label TEXT, 
	PRIMARY KEY (id)
);
...
CREATE TABLE "MetabolicProcess" (
	...
	outputs TEXT, 
	PRIMARY KEY (id), 
	FOREIGN KEY(category) REFERENCES "MetabolicProcessCategory" (id)
);

CREATE TABLE "MetabolicProcess_synonyms" (
	backref_id TEXT, 
	synonyms TEXT, 
	PRIMARY KEY (backref_id, synonyms), 
	FOREIGN KEY(backref_id) REFERENCES "MetabolicProcess" (id)
);
