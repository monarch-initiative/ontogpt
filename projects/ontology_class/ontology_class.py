# Auto generated from ontology_class.yaml by pythongen.py version: 0.9.0
# Generation date: 2023-08-07T10:55:23
...
class RelationId(NamedEntityId):
    pass
...
@dataclass
class LogicalDefinition(YAMLRoot):
    _inherited_slots: ClassVar[List[str]] = []

    class_class_uri: ClassVar[URIRef] = OC.LogicalDefinition
    class_class_curie: ClassVar[str] = "oc:LogicalDefinition"
    class_name: ClassVar[str] = "LogicalDefinition"
    class_model_uri: ClassVar[URIRef] = OC.LogicalDefinition

    genus: Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]] = empty_list()
    differentiating_characteristic_relationship: Optional[Union[str, RelationId]] = None
    differentiating_characteristic_parents: Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]] = empty_list()

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if not isinstance(self.genus, list):
            self.genus = [self.genus] if self.genus is not None else []
        self.genus = [v if isinstance(v, OntologyClassId) else OntologyClassId(v) for v in self.genus]

        if self.differentiating_characteristic_relationship is not None and not isinstance(self.differentiating_characteristic_relationship, RelationId):
            self.differentiating_characteristic_relationship = RelationId(self.differentiating_characteristic_relationship)

        if not isinstance(self.differentiating_characteristic_parents, list):
            self.differentiating_characteristic_parents = [self.differentiating_characteristic_parents] if self.differentiating_characteristic_parents is not None else []
        self.differentiating_characteristic_parents = [v if isinstance(v, OntologyClassId) else OntologyClassId(v) for v in self.differentiating_characteristic_parents]
...
class OntologyClass(NamedEntity):
    ...
    categories: Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]] = empty_list()
    subclass_of: Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]] = empty_list()
    logical_definition: Optional[Union[dict, "LogicalDefinition"]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.categories = [v if isinstance(v, OntologyClassId) else OntologyClassId(v) for v in self.categories]
        ...
        if self.logical_definition is not None and not isinstance(self.logical_definition, LogicalDefinition):
            self.logical_definition = LogicalDefinition(**as_dict(self.logical_definition))
...
class Relation(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = OC.Relation
    class_class_curie: ClassVar[str] = "oc:Relation"
    class_name: ClassVar[str] = "Relation"
    class_model_uri: ClassVar[URIRef] = OC.Relation

    id: Union[str, RelationId] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(self.id, RelationId):
            self.id = RelationId(self.id)
...
slots.ontologyClass__label = Slot(uri=OC.label, name="ontologyClass__label", curie=OC.curie('label'),
                   model_uri=OC.ontologyClass__label, domain=None, range=Optional[str])

slots.ontologyClass__description = Slot(uri=OC.description, name="ontologyClass__description", curie=OC.curie('description'),
                   model_uri=OC.ontologyClass__description, domain=None, range=Optional[str])

slots.ontologyClass__synonyms = Slot(uri=OC.synonyms, name="ontologyClass__synonyms", curie=OC.curie('synonyms'),
                   model_uri=OC.ontologyClass__synonyms, domain=None, range=Optional[Union[str, List[str]]])

slots.ontologyClass__categories = Slot(uri=OC.categories, name="ontologyClass__categories", curie=OC.curie('categories'),
                   model_uri=OC.ontologyClass__categories, domain=None, range=Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]])

slots.ontologyClass__subclass_of = Slot(uri=OC.subclass_of, name="ontologyClass__subclass_of", curie=OC.curie('subclass_of'),
                   model_uri=OC.ontologyClass__subclass_of, domain=None, range=Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]])

slots.ontologyClass__logical_definition = Slot(uri=OC.logical_definition, name="ontologyClass__logical_definition", curie=OC.curie('logical_definition'),
                   model_uri=OC.ontologyClass__logical_definition, domain=None, range=Optional[Union[dict, LogicalDefinition]])

slots.logicalDefinition__genus = Slot(uri=OC.genus, name="logicalDefinition__genus", curie=OC.curie('genus'),
                   model_uri=OC.logicalDefinition__genus, domain=None, range=Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]])

slots.logicalDefinition__differentiating_characteristic_relationship = Slot(uri=OC.differentiating_characteristic_relationship, name="logicalDefinition__differentiating_characteristic_relationship", curie=OC.curie('differentiating_characteristic_relationship'),
                   model_uri=OC.logicalDefinition__differentiating_characteristic_relationship, domain=None, range=Optional[Union[str, RelationId]])

slots.logicalDefinition__differentiating_characteristic_parents = Slot(uri=OC.differentiating_characteristic_parents, name="logicalDefinition__differentiating_characteristic_parents", curie=OC.curie('differentiating_characteristic_parents'),
                   model_uri=OC.logicalDefinition__differentiating_characteristic_parents, domain=None, range=Optional[Union[Union[str, OntologyClassId], List[Union[str, OntologyClassId]]]])
