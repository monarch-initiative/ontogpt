...
CREATE TABLE "CompositeDisease" (
	...
	PRIMARY KEY (main_disease, drugs, treatments, contraindications, treatment_mechanisms, treatment_efficacies, treatment_adverse_effects), 
	FOREIGN KEY(main_disease) REFERENCES "Disease" (id)
);
