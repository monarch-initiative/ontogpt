# Auto generated from metagenome_study.yaml by pythongen.py version: 0.9.0
# Generation date: 2023-08-07T10:55:11
# Schema: environmental-metagenome
#
# id: http://w3id.org/ontogpt/metagenome
# description: A template for Environmental Metagenome Studies
...
IDO = CurieNamespace('IDO', 'http://example.org/UNKNOWN/IDO/')
...
PECO = CurieNamespace('PECO', 'http://example.org/UNKNOWN/PECO/')
...
EG = CurieNamespace('eg', 'http://w3id.org/ontogpt/environmental-metagenome/')
...
class SequencingTechnologyId(NamedEntityId):
    pass
...
class Study(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Study
    class_class_curie: ClassVar[str] = "eg:Study"
    class_name: ClassVar[str] = "Study"
    class_model_uri: ClassVar[URIRef] = EG.Study
    ...
    sequencing_technologies: Optional[Union[str, SequencingTechnologyId]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.sequencing_technologies is not None and not isinstance(self.sequencing_technologies, SequencingTechnologyId):
            self.sequencing_technologies = SequencingTechnologyId(self.sequencing_technologies)
...
class ExtractionResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = EG.ExtractionResult
...
class NamedEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = EG.NamedEntity
...
class Location(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Location
    class_class_curie: ClassVar[str] = "eg:Location"
    class_name: ClassVar[str] = "Location"
    class_model_uri: ClassVar[URIRef] = EG.Location
...
class EnvironmentalMaterial(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.EnvironmentalMaterial
    class_class_curie: ClassVar[str] = "eg:EnvironmentalMaterial"
    class_name: ClassVar[str] = "EnvironmentalMaterial"
    class_model_uri: ClassVar[URIRef] = EG.EnvironmentalMaterial
...
class Environment(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Environment
    class_class_curie: ClassVar[str] = "eg:Environment"
    class_name: ClassVar[str] = "Environment"
    class_model_uri: ClassVar[URIRef] = EG.Environment
...
class Variable(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Variable
    class_class_curie: ClassVar[str] = "eg:Variable"
    class_name: ClassVar[str] = "Variable"
    class_model_uri: ClassVar[URIRef] = EG.Variable
...
class Unit(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Unit
    class_class_curie: ClassVar[str] = "eg:Unit"
    class_name: ClassVar[str] = "Unit"
    class_model_uri: ClassVar[URIRef] = EG.Unit
...
class SequencingTechnology(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.SequencingTechnology
    class_class_curie: ClassVar[str] = "eg:SequencingTechnology"
    class_name: ClassVar[str] = "SequencingTechnology"
    class_model_uri: ClassVar[URIRef] = EG.SequencingTechnology

    id: Union[str, SequencingTechnologyId] = None

    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        if self._is_empty(self.id):
            self.MissingRequiredField("id")
        if not isinstance(self.id, SequencingTechnologyId):
            self.id = SequencingTechnologyId(self.id)
...
class Treatment(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Treatment
    class_class_curie: ClassVar[str] = "eg:Treatment"
    class_name: ClassVar[str] = "Treatment"
    class_model_uri: ClassVar[URIRef] = EG.Treatment
...
class Organism(NamedEntity):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Organism
    class_class_curie: ClassVar[str] = "eg:Organism"
    class_name: ClassVar[str] = "Organism"
    class_model_uri: ClassVar[URIRef] = EG.Organism
...
class CompoundExpression(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = EG.CompoundExpression
...
class Measurement(CompoundExpression):
    ...
    class_class_uri: ClassVar[URIRef] = EG.Measurement
    class_class_curie: ClassVar[str] = "eg:Measurement"
    class_name: ClassVar[str] = "Measurement"
    class_model_uri: ClassVar[URIRef] = EG.Measurement
...
class CausalRelationship(CompoundExpression):
    ...
    class_class_uri: ClassVar[URIRef] = EG.CausalRelationship
    class_class_curie: ClassVar[str] = "eg:CausalRelationship"
    class_name: ClassVar[str] = "CausalRelationship"
    class_model_uri: ClassVar[URIRef] = EG.CausalRelationship
...
class Triple(CompoundExpression):
    ...
    class_model_uri: ClassVar[URIRef] = EG.Triple
...
class TextWithTriples(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = EG.TextWithTriples
...
class RelationshipType(NamedEntity):
    ...
    class_model_uri: ClassVar[URIRef] = EG.RelationshipType
...
class Publication(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = EG.Publication
...
class AnnotatorResult(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = EG.AnnotatorResult
...
slots.study__environments = Slot(uri=EG.environments, name="study__environments", curie=EG.curie('environments'),
                   model_uri=EG.study__environments, domain=None, range=Optional[Union[Union[str, EnvironmentId], List[Union[str, EnvironmentId]]]])

slots.study__causal_relationships = Slot(uri=EG.causal_relationships, name="study__causal_relationships", curie=EG.curie('causal_relationships'),
                   model_uri=EG.study__causal_relationships, domain=None, range=Optional[Union[Union[dict, CausalRelationship], List[Union[dict, CausalRelationship]]]])

slots.study__variables = Slot(uri=EG.variables, name="study__variables", curie=EG.curie('variables'),
                   model_uri=EG.study__variables, domain=None, range=Optional[Union[Union[str, VariableId], List[Union[str, VariableId]]]])

slots.study__treatments = Slot(uri=EG.treatments, name="study__treatments", curie=EG.curie('treatments'),
                   model_uri=EG.study__treatments, domain=None, range=Optional[Union[Union[str, TreatmentId], List[Union[str, TreatmentId]]]])

slots.study__measurements = Slot(uri=EG.measurements, name="study__measurements", curie=EG.curie('measurements'),
                   model_uri=EG.study__measurements, domain=None, range=Optional[Union[Union[dict, Measurement], List[Union[dict, Measurement]]]])

slots.study__location = Slot(uri=EG.location, name="study__location", curie=EG.curie('location'),
                   model_uri=EG.study__location, domain=None, range=Optional[Union[Union[str, LocationId], List[Union[str, LocationId]]]])

slots.study__environmental_material = Slot(uri=EG.environmental_material, name="study__environmental_material", curie=EG.curie('environmental_material'),
                   model_uri=EG.study__environmental_material, domain=None, range=Optional[Union[Union[str, EnvironmentalMaterialId], List[Union[str, EnvironmentalMaterialId]]]])

slots.study__sequencing_technologies = Slot(uri=EG.sequencing_technologies, name="study__sequencing_technologies", curie=EG.curie('sequencing_technologies'),
                   model_uri=EG.study__sequencing_technologies, domain=None, range=Optional[Union[str, SequencingTechnologyId]])

slots.study__organisms = Slot(uri=EG.organisms, name="study__organisms", curie=EG.curie('organisms'),
                   model_uri=EG.study__organisms, domain=None, range=Optional[Union[Union[str, OrganismId], List[Union[str, OrganismId]]]])

slots.measurement__value = Slot(uri=EG.value, name="measurement__value", curie=EG.curie('value'),
                   model_uri=EG.measurement__value, domain=None, range=Optional[str])

slots.measurement__unit = Slot(uri=EG.unit, name="measurement__unit", curie=EG.curie('unit'),
                   model_uri=EG.measurement__unit, domain=None, range=Optional[Union[str, UnitId]])

slots.causalRelationship__cause = Slot(uri=EG.cause, name="causalRelationship__cause", curie=EG.curie('cause'),
                   model_uri=EG.causalRelationship__cause, domain=None, range=Optional[Union[str, VariableId]])

slots.causalRelationship__effect = Slot(uri=EG.effect, name="causalRelationship__effect", curie=EG.curie('effect'),
                   model_uri=EG.causalRelationship__effect, domain=None, range=Optional[Union[str, VariableId]])

slots.extractionResult__input_id = Slot(uri=CORE.input_id, name="extractionResult__input_id", curie=CORE.curie('input_id'),
                   model_uri=EG.extractionResult__input_id, domain=None, range=Optional[str])
...
slots.extractionResult__input_title = Slot(uri=CORE.input_title, name="extractionResult__input_title", curie=CORE.curie('input_title'),
                   model_uri=EG.extractionResult__input_title, domain=None, range=Optional[str])
...
slots.extractionResult__input_text = Slot(uri=CORE.input_text, name="extractionResult__input_text", curie=CORE.curie('input_text'),
                   model_uri=EG.extractionResult__input_text, domain=None, range=Optional[str])
...
slots.extractionResult__raw_completion_output = Slot(uri=CORE.raw_completion_output, name="extractionResult__raw_completion_output", curie=CORE.curie('raw_completion_output'),
                   model_uri=EG.extractionResult__raw_completion_output, domain=None, range=Optional[str])

slots.extractionResult__prompt = Slot(uri=CORE.prompt, name="extractionResult__prompt", curie=CORE.curie('prompt'),
                   model_uri=EG.extractionResult__prompt, domain=None, range=Optional[str])
...
slots.extractionResult__extracted_object = Slot(uri=CORE.extracted_object, name="extractionResult__extracted_object", curie=CORE.curie('extracted_object'),
                   model_uri=EG.extractionResult__extracted_object, domain=None, range=Optional[Union[dict, Any]])
...
slots.triple__subject_qualifier = Slot(uri=CORE.subject_qualifier, name="triple__subject_qualifier", curie=CORE.curie('subject_qualifier'),
                   model_uri=EG.triple__subject_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.triple__object_qualifier = Slot(uri=CORE.object_qualifier, name="triple__object_qualifier", curie=CORE.curie('object_qualifier'),
                   model_uri=EG.triple__object_qualifier, domain=None, range=Optional[Union[str, NamedEntityId]])
...
slots.textWithTriples__publication = Slot(uri=CORE.publication, name="textWithTriples__publication", curie=CORE.curie('publication'),
                   model_uri=EG.textWithTriples__publication, domain=None, range=Optional[Union[dict, Publication]])

slots.textWithTriples__triples = Slot(uri=CORE.triples, name="textWithTriples__triples", curie=CORE.curie('triples'),
                   model_uri=EG.textWithTriples__triples, domain=None, range=Optional[Union[Union[dict, Triple], List[Union[dict, Triple]]]])

slots.publication__id = Slot(uri=CORE.id, name="publication__id", curie=CORE.curie('id'),
                   model_uri=EG.publication__id, domain=None, range=Optional[str])

slots.publication__title = Slot(uri=CORE.title, name="publication__title", curie=CORE.curie('title'),
                   model_uri=EG.publication__title, domain=None, range=Optional[str])

slots.publication__abstract = Slot(uri=CORE.abstract, name="publication__abstract", curie=CORE.curie('abstract'),
                   model_uri=EG.publication__abstract, domain=None, range=Optional[str])
...
slots.publication__combined_text = Slot(uri=CORE.combined_text, name="publication__combined_text", curie=CORE.curie('combined_text'),
                   model_uri=EG.publication__combined_text, domain=None, range=Optional[str])

slots.publication__full_text = Slot(uri=CORE.full_text, name="publication__full_text", curie=CORE.curie('full_text'),
                   model_uri=EG.publication__full_text, domain=None, range=Optional[str])
...
slots.annotatorResult__subject_text = Slot(uri=CORE.subject_text, name="annotatorResult__subject_text", curie=CORE.curie('subject_text'),
                   model_uri=EG.annotatorResult__subject_text, domain=None, range=Optional[str])

slots.annotatorResult__object_id = Slot(uri=CORE.object_id, name="annotatorResult__object_id", curie=CORE.curie('object_id'),
                   model_uri=EG.annotatorResult__object_id, domain=None, range=Optional[str])
...
slots.annotatorResult__object_text = Slot(uri=CORE.object_text, name="annotatorResult__object_text", curie=CORE.curie('object_text'),
                   model_uri=EG.annotatorResult__object_text, domain=None, range=Optional[str])