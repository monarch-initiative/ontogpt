...
from ontogpt.engines.knowledge_engine import MODEL_GPT_4, MODEL_GPT_3_5_TURBO, MODEL_TEXT_DAVINCI_003
...
model = col1.selectbox(
    'Select the model:',
    (MODEL_GPT_3_5_TURBO, MODEL_TEXT_DAVINCI_003, MODEL_GPT_4)
)
