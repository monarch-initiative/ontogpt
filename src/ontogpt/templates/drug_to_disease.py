...
linkml_meta = LinkMLMeta({'default_prefix': 'drug_to_disease',
     'default_range': 'string',
     'description': 'A template for extracting relationships between drugs and '
                    'diseases',
     'id': 'http://w3id.org/ontogpt/drug',
     'imports': ['linkml:types', 'core'],
     'license': 'https://creativecommons.org/publicdomain/zero/1.0/',
     'name': 'drug_to_disease',
     'prefixes': {'HGNC': {'prefix_prefix': 'HGNC',
     ...
     'source_file': 'src/ontogpt/templates/drug_to_disease.yaml',
...
class Triple(CompoundExpression):
    ...
    subject: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'subject', 'domain_of': ['Triple', 'DrugToDisease']} })
    predicate: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'predicate', 'domain_of': ['Triple', 'DrugToDisease']} })
    object: Optional[str] = Field(None, json_schema_extra = { "linkml_meta": {'alias': 'object', 'domain_of': ['Triple', 'DrugToDisease']} })
...
class DrugToDisease(CompoundExpression):
