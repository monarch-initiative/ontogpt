...
linkml_meta = LinkMLMeta({'default_prefix': 'vbo_names',
     'default_range': 'string',
     'description': 'An extraction template for animal names present in VBO',
     ...
     'prefixes': {'linkml': {'prefix_prefix': 'linkml',
                  ...
                  'vbo_names': {'prefix_prefix': 'vbo_names',
                                'prefix_reference': 'http://w3id.org/ontogpt/ecosim_simple'}},
     'source_file': '/home/harry/ontogpt/src/ontogpt/templates/vbo_names.yaml',
...
class NameSet(NamedEntity):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'http://w3id.org/ontogpt/vbo_names', 'tree_root': True})
...
class AnimalName(NamedEntity):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'annotators': {'tag': 'annotators', 'value': 'sqlite:obo:vbo'},
         ...
         'from_schema': 'http://w3id.org/ontogpt/vbo_names'})
