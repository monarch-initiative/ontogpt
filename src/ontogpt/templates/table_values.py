...
class Table(ConfiguredBaseModel):
    ...
    rows: Optional[List[TableRow]] = Field(None, description="""“List of row objects in the table.”""", json_schema_extra = { "linkml_meta": {'alias': 'rows', 'domain_of': ['Table']} })
    columns: Optional[List[TableColumn]] = Field(None, description="""“List of column objects in the table.”""", json_schema_extra = { "linkml_meta": {'alias': 'columns', 'domain_of': ['Table']} })
    cells: Optional[List[TableCell]] = Field(None, description="""“List of cell objects representing the intersection of each row and column.”""", json_schema_extra = { "linkml_meta": {'alias': 'cells', 'domain_of': ['Table']} })
...
class TableRow(ConfiguredBaseModel):
    ...
    row_label: Optional[str] = Field(None, description="""“Label describing the row (e.g., a variable, category, subject).”""", json_schema_extra = { "linkml_meta": {'alias': 'row_label', 'domain_of': ['TableRow']} })
    row_index: Optional[int] = Field(None, description="""“Numeric index of this row (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'row_index', 'domain_of': ['TableRow', 'TableCell']} })
...
class TableColumn(ConfiguredBaseModel):
    ...
    column_label: Optional[str] = Field(None, description="""“Label describing the column (e.g., timepoint, parameter).”""", json_schema_extra = { "linkml_meta": {'alias': 'column_label', 'domain_of': ['TableColumn']} })
    column_index: Optional[int] = Field(None, description="""“Numeric index of this column (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'column_index', 'domain_of': ['TableColumn', 'TableCell']} })
...
class TableCell(ConfiguredBaseModel):
    ...
    row_index: Optional[int] = Field(None, description="""“Numeric index of this row (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'row_index', 'domain_of': ['TableRow', 'TableCell']} })
    column_index: Optional[int] = Field(None, description="""“Numeric index of this column (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'column_index', 'domain_of': ['TableColumn', 'TableCell']} })
    value: Optional[float] = Field(None, description="""“Numeric value in this cell.”""", json_schema_extra = { "linkml_meta": {'alias': 'value', 'domain_of': ['TableCell']} })
    unit: Optional[str] = Field(None, description="""“Optional unit (e.g., mg, kg, mL).”""", json_schema_extra = { "linkml_meta": {'alias': 'unit', 'domain_of': ['TableCell']} })
    note: Optional[str] = Field(None, description="""“Optional note or comment about this particular cell.”""", json_schema_extra = { "linkml_meta": {'alias': 'note', 'domain_of': ['TableCell']} })
