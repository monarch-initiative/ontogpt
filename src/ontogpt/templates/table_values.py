...
linkml_meta = LinkMLMeta({'default_prefix': 'STE',
     'description': 'An OntoGPT schema for extracting simple numerical tables with '
                    'row/column labels from PDF publications',
     'id': 'https://w3id.org/ontogpt/table_values',
     'imports': ['core'],
     'name': 'SimpleTableExtraction',
     'source_file': 'src/ontogpt/templates/table_values.yaml'} )
...
class Table(ConfiguredBaseModel):
    """
    “A table extracted from a publication, containing rows and columns of numerical data.”
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/ontogpt/table_values'})
    ...
    rows: Optional[List[TableRow]] = Field(default=None, description="""“List of row objects in the table.”""", json_schema_extra = { "linkml_meta": {'alias': 'rows', 'domain_of': ['Table']} })
    columns: Optional[List[TableColumn]] = Field(default=None, description="""“List of column objects in the table.”""", json_schema_extra = { "linkml_meta": {'alias': 'columns', 'domain_of': ['Table']} })
    cells: Optional[List[TableCell]] = Field(default=None, description="""“List of cell objects representing the intersection of each row and column.”""", json_schema_extra = { "linkml_meta": {'alias': 'cells', 'domain_of': ['Table']} })


class TableRow(ConfiguredBaseModel):
    """
    “A single row in the table, with a label identifying the row.”
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/ontogpt/table_values'})

    row_label: Optional[str] = Field(default=None, description="""“Label describing the row (e.g., a variable, category, subject).”""", json_schema_extra = { "linkml_meta": {'alias': 'row_label', 'domain_of': ['TableRow']} })
    row_index: Optional[int] = Field(default=None, description="""“Numeric index of this row (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'row_index', 'domain_of': ['TableRow', 'TableCell']} })


class TableColumn(ConfiguredBaseModel):
    """
    “A single column in the table, with a label identifying the column.”
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/ontogpt/table_values'})

    column_label: Optional[str] = Field(default=None, description="""“Label describing the column (e.g., timepoint, parameter).”""", json_schema_extra = { "linkml_meta": {'alias': 'column_label', 'domain_of': ['TableColumn']} })
    column_index: Optional[int] = Field(default=None, description="""“Numeric index of this column (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'column_index', 'domain_of': ['TableColumn', 'TableCell']} })


class TableCell(ConfiguredBaseModel):
    """
    “An individual cell in the table, containing a numerical value and optional qualifiers.”
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/ontogpt/table_values'})

    row_index: Optional[int] = Field(default=None, description="""“Numeric index of this row (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'row_index', 'domain_of': ['TableRow', 'TableCell']} })
    column_index: Optional[int] = Field(default=None, description="""“Numeric index of this column (starting from 0 or 1).”""", json_schema_extra = { "linkml_meta": {'alias': 'column_index', 'domain_of': ['TableColumn', 'TableCell']} })
    value: Optional[float] = Field(default=None, description="""“Numeric value in this cell.”""", json_schema_extra = { "linkml_meta": {'alias': 'value', 'domain_of': ['TableCell']} })
    unit: Optional[str] = Field(default=None, description="""“Optional unit (e.g., mg, kg, mL).”""", json_schema_extra = { "linkml_meta": {'alias': 'unit', 'domain_of': ['TableCell']} })
    note: Optional[str] = Field(default=None, description="""“Optional note or comment about this particular cell.”""", json_schema_extra = { "linkml_meta": {'alias': 'note', 'domain_of': ['TableCell']} })
