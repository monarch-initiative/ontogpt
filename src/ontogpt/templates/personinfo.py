...
linkml_meta = LinkMLMeta({'default_prefix': 'personinfo',
     ...
     'source_file': '/home/harry/ontogpt/src/ontogpt/templates/personinfo.yaml'} )
...
class NamedEntity(ConfiguredBaseModel):
    ...
    id: str = Field(..., description="""A unique identifier for the named entity""", json_schema_extra = { "linkml_meta": {'alias': 'id',
         ...
         'domain_of': ['NamedEntity', 'Publication', 'Person']} })
...
class Publication(ConfiguredBaseModel):
    ...
    id: Optional[str] = Field(None, description="""The publication identifier""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['NamedEntity', 'Publication', 'Person']} })
...
class Container(ConfiguredBaseModel):
    ...
    persons: Optional[List[Person]] = Field(None, description="""A semicolon-delimited list of people named in the text.""", json_schema_extra = { "linkml_meta": {'alias': 'persons',
         'annotations': {'owl': {'tag': 'owl',
...
class Person(NamedEntity):
    ...
    full_name: Optional[str] = Field(None, description="""The full name of the person.""", json_schema_extra = { "linkml_meta": {'alias': 'full_name', 'domain_of': ['Person']} })
    id: str = Field(..., description="""A unique identifier for the person. This is their full name without spaces or special characters.""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['NamedEntity', 'Publication', 'Person']} })
    label: Optional[str] = Field(None, description="""The label (name) of the named thing""", json_schema_extra = { "linkml_meta": {'alias': 'label',
         'aliases': ['name'],
         'annotations': {'owl': {'tag': 'owl',
                                 'value': 'AnnotationProperty, AnnotationAssertion'}},
