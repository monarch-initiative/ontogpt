...
class ConditionDiagnosisSeverity(str, Enum):
...
class ConditionProblemDiagnosisIdentifier(str):
...
class Condition(NamedEntity):
    ...
    label: Optional[str] = Field(None, description="""The concise name of the condition, problem, or diagnosis.""")
    clinical_status: ConditionClinicalStatus = Field("\"unknown\"", description="""The clinical status of the condition.""")
    severity: Optional[ConditionDiagnosisSeverity] = Field(None, description="""Subjective severity of condition.""")
    code: str = Field(..., description="""The condition, problem, or diagnosis found in this note.""")
    id: str = Field(..., description="""A unique identifier for the named entity""")
    
    

class ConditionProblemDiagnosis(NamedEntity):
